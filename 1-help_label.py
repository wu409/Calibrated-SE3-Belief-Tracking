    ...
    for seq_target in args.target_seqs:
        ...
        for dot in args.corruption_lists:   
            ...
            for i in range(2, min(len(pred_files), len(gt_files))):
                ...
                #print(f"帧 {i}: E_update={e_update_norm:.2f}cm | E_prior={e_prior_norm:.2f}cm | Help={help_label}")
                ...
                x1_depth_residual = reliability_depth_residual(depth_real, T_obs, scene,renderer,mesh_node)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cad_models_seq', nargs='+', default=["021_bleach_cleanser","021_bleach_cleanser","006_mustard_bottle"], help="CAD model list")
    parser.add_argument('--delta', type=float, default=0.5, help="marigin_rate")
